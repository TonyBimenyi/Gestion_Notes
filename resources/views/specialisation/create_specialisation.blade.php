...
<body>
    <div class="container">
        ...
        <div class="form">
            <h3 style="margin:10px 35px;color:var(--primary)">Add a specialization</h3>
                    ...
                    <div class="row">
                        <div class="input_row">
                            ...
                            <div class="input_group">
                                ...
                                <div class="input">
                                    <input type="text" name="namespec" placeholder="Specialization Name..." required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input_group">
                                ...
                                <div class="select">
                                    <select name="facSpec" id="state">
                                        ...
                                        @foreach ($create_specialisation as $fac)
